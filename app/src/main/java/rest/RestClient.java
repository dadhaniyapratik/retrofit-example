...
public class RestClient {
    ...
    private static String baseUrl = "http://microblogging.wingnity.com/" ;
...
//        @Headers("User-Agent: Retrofit2.0Tutorial-App")
        ...
        Call<ActorContact> getUsersNamedTom(@Query("q") String name);

//        @POST("/user/create")
//        Call<Item> createUser(@Body LoginInformation loginInformation);
//
//        @PUT("/user/{id}/update")
